      ...
      <Slider {...settings}>
        {services.map(service => (
          <div key={service.id} className="p-4">
            <div className="service-item border rounded-lg p-4 shadow-lg transition-transform transform hover:scale-105 duration-300">
              <img src={service.imageUrl} alt={service.title} className="w-full h-48 object-cover mb-4" />
